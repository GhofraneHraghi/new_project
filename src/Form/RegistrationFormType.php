...
class RegistrationFormType extends AbstractType
{
    ...
    {
        $builder
        //les propriétés de notre entités
            ...
            ->add('adress', TextType::class,['attr'=>['class'=>'form-control'],'label' =>'Adress'])
            ...
            ->add('RGPDConsent', CheckboxType::class, [//pour que l'user valide qu'il veut utiliser ses données pour inscrire
                'mapped' => false,
                'constraints' => [
                    new IsTrue([
